...
class AllureReporter extends events.EventEmitter {
    ...
    testStart(test) {
        ...
        // Device name & Browser Name Parameters
        const browserName = test.runner[test.cid].browserName;
        const deviceName = test.runner[test.cid].deviceName;
        currentTest.addParameter('argument','device',deviceName);
    ...
    cucumberSuiteStart(suite) {
        ...
        if (!suite.parent) {
            ...
            if (suite.title) {
                ...
                const deviceName = suite.runner[suite.cid].deviceName;
                test.addParameter('argument','device',deviceName);
